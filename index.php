<html>
  ...
  <body>
    <h1>CWV Demo</h1>
		...
		<p>
		  Each one of the pages below will purposefully create bad [Core Web Vitals](https://web.dev/vitals) scores. You can check those using Google's Chrome Extension [Web Vitals](https://chrome.google.com/webstore/detail/web-vitals/ahfhijdlegdabablpippeagghigmibma).
		</p>
		<p>
